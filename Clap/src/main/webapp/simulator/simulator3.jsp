						...
						<div class="col-md-7 opacityDiv" >
							...
							<c:forEach begin="1" end="7" varStatus="row">
								<div class="col-md-6 col-sm-12">
									<img src="<c:url value="/resource/images/simulator/o_${row.index+1}.png"/>">
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ${row.index+1}">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ${row.index+1}">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ${row.index+1}">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ${row.index+1}">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
							</c:forEach>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ2">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ2">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ2">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ2">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ3">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ3">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ3">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ3">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ4">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ4">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ4">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ4">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ5">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ5">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ5">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ5">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ6">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ6">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ6">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ6">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									...
									<div class="graphic_detail_all">
										<div class="graphic_detail">
											<span style="width: 70px;" class="o_old organ7">Power</span><strong>60%</strong> <span style="background: #72B3BF; width: 200px;"
												class="o_new organ7">Power</span><strong>80%</strong>
										</div>
										<div class="graphic_detail">
											<span style="width: 90px;" class="o_old organ7">Endurance</span><strong>60%</strong> <span style="background: #16536C; width: 250px;"
												class="o_new organ7">Endurance</span><strong>80%</strong>
										</div>
									</div>
								</div>
							</div>
