		...
		<div id="shoppingbanner" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img class="first-slide" src="${pageContext.request.contextPath}/resource/images/banner-1.jpg"
						alt="See more future.">
					<div class="container">
				...
				<div class="item">
					<img class="third-slide" src="${pageContext.request.contextPath}/resource/images/banner-2.jpg"
