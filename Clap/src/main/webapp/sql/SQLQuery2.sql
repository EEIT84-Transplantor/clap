...
insert into member(mb_email,mb_password,mb_name,mb_phone,mb_contenttype,mb_photo,mb_oneclick,mb_autorenew,mb_expire,mb_amount,hospital_id,cc_number) values('pabla672@gmail.com',0x65,'pabla672','0985852981',null,null,'FALSE','FALSE',null,null,null,null);insert into message(msg_id ,mb_email,msg_sender,msg_subject,msg_content,msg_date,msg_deleted) values(2,'jay433@gmail.com','admin@gmail.com','[���i] 2016/05/05 ��� 4:00 ~ 6:00 �������i','�˷R���|���j�a�n�G���F���ѵ��Ҧ��|�����u�誺�����A�ȫ~��,�ڭ̱N�� 2016/05/05 �i������]�ƪ���s�P�ɯŬ��O�D�ֳt�a�����o�Ӱʧ@�A���ɥ����|�i�J�������A�A���槹���B���յL�~��|�ɳt�}��A�ȡA�P�¦U��|��������P�t�X�I','2016-4-4',0);
...
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('1','Heart','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('2','Lung','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('3','Liver','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('4','Kidney','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('5','Stomach','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('6','Intestine','Endurance','100','Skill','100');
insert into category(category_id,category_name,category_specialty,category_value1,category_specialty_plus,category_value2) values('7','Blood','RBC','Endurance','Skill','100');
