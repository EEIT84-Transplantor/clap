				...
				<div class="col-md-12">
					<form action="login.servlet" method="post" id="sign_form">
						<div class="row form_title">
							<p class="col-md-12">
							<h3>Welcome to C.L.A.P</h3>
							<span>Please Enter your email below for Login / Sign Up</span>
							</p>
						</div>
						...
						<c:if test="${empty requestScope.error}">
							<div class="row">
								<input type="button" value="Next" id="emailcheck_btn" class="btn col-md-12" />
							</div>
						</c:if>
						...
						<div id="password_area">
							<c:if test="${not empty requestScope.error}">
								<div class="row" id="password_group">
									...
									<div class="row">
										<span>need more help?</span><a href="#" id="forgotPassword">forgot password</a>
									</div>
								</div>
							</c:if>
