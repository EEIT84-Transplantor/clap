			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<div class="row">
						...
						<button type="button" class="btn btn-primary btn-lg col-md-4">Payment
							Manage</button>
						<div class="col-md-2"></div>
						<button type="button" class="btn btn-default btn-lg col-md-4">Change
							Password</button>
						<div class="col-md-1"></div>
					</div>
					<br>
					<div class="row">
						...
						<button type="button" class="btn btn-default btn-lg col-md-4">Change
							Setting</button>
						<div class="col-md-2"></div>
						<button type="button" class="btn btn-primary btn-lg col-md-4">Set
							Oneclick Shopping</button>
						<div class="col-md-1"></div>
					</div>
					<br>
					<div class="row">
						<div class="col-md-1"></div>
						<button type="button" class="btn btn-primary btn-lg col-md-4">Activate
							VIP</button>
						<div class="col-md-2"></div>
						<button type="button" class="btn btn-default btn-lg col-md-4">Mail
							Box</button>
						<div class="col-md-1"></div>
					</div>
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					...
					var paymentmanageUrl = contextPath
							+ "/payment/paymentmanage.jsp";
					var passwordchangeUrl = contextPath
							+ "/setting/passwordchange.jsp";
					var changesettingUrl = contextPath
							+ "/setting/changesetting.jsp";
